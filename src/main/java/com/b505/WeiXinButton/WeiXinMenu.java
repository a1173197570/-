...
public class WeiXinMenu {
    ...
    public static Menu getMenu() {
        ...
        btn13.setName("彪");
        btn13.setType("view");
        btn13.setUrl("https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx6dab4029668e1ee4&redirect_uri=http://02c2bdbb.ngrok.io/text1&response_type=code&scope=snsapi_userinfo&state=STATE&connect_redirect=1#wechat_redirect");
